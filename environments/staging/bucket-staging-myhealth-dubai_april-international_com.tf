...
module "bucket-staging-myhealth-dubai_april-international_com" {
  source = "../../modules/s3"
  ...
  isProd = false
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-staging-myhealth-dubai_april-international_com.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-staging-myhealth-dubai_april-international_com" {
statement {
