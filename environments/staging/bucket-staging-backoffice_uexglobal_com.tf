...
module "bucket-staging-backoffice_uexglobal_com" {
  source = "../../modules/s3"
  ...
  isProd = false
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-staging-backoffice_uexglobal_com.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-staging-backoffice_uexglobal_com" {
statement {
