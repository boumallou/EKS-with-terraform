...
module "bucket-staging-myhealth-sg_april_asia" {
  source = "../../modules/s3"
  ...
  isProd = false
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-staging-myhealth-sg_april_asia.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-staging-myhealth-sg_april_asia" {
statement {
