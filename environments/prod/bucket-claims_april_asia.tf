...
module "bucket-claims_april_asia" {
  source = "../../modules/s3"
  ...
  isProd = true
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-claims_april_asia.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-claims_april_asia" {
statement {
