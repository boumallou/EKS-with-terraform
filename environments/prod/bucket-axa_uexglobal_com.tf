...
module "bucket-axa_uexglobal_com" {
  source = "../../modules/s3"
  ...
  isProd = true
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-axa_uexglobal_com.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-axa_uexglobal_com" {
statement {
