...
# module "bucket-myhealth-sg_uexglobal_com" {
#   source = "../../modules/s3"
#          providers = {
#     aws = aws.Virginia
#   }
...
#   isProd = true
#   addPolicy = true
#   bucket-policy =  data.aws_iam_policy_document.bucket-policy-myhealth-sg_uexglobal_com.json
#   tag = {
...
#   }
# }
# data "aws_iam_policy_document" "bucket-policy-myhealth-sg_uexglobal_com" {
# statement {
