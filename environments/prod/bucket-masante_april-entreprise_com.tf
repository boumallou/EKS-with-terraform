...
# module "bucket-masante_april-entreprise_com" {
#   source = "../../modules/s3"
#      providers = {
#     aws = aws.Paris
#   }
...
#   isProd = true
#   addPolicy = true
#   bucket-policy =  data.aws_iam_policy_document.bucket-policy-masante_april-entreprise_com.json
#   tag = {
...
#   }
# }
# data "aws_iam_policy_document" "bucket-policy-masante_april-entreprise_com" {
# statement {
