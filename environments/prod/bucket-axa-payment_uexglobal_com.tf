...
module "bucket-axa-payment_uexglobal_com" {
  source = "../../modules/s3"
  ...
  isProd = true
  addPolicy = true
  bucket-policy =  data.aws_iam_policy_document.bucket-policy-axa-payment_uexglobal_com.json
  tag = {
...
data "aws_iam_policy_document" "bucket-policy-axa-payment_uexglobal_com" {
statement {
